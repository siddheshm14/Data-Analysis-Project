...
def run_app():
    ...
    st.sidebar.info('This application works  in two modes 1). InPerson mode where you can predict diabetes individually. '
    ...
    if add_selectbox=='In Person':
        ...
        if st.button("Predict Diabetes"):
            ...
            if output==0:
                ...
                st.error('You are diabetic .Please take care')
    ...
    if add_selectbox == 'Batch':
        ...
        url='https://drive.google.com/file/d/1znVoIjEzfU0YpOKmMMrh3EQD5z0i_kDj/view?usp=sharing'
